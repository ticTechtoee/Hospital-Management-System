        ...
        Else
            ...
            Try
                ...
                If (txtStatus.Text = "Discharged.") Then
                    insertString = "DELETE FROM `patient_medicinem` WHERE ID='" & txtID.Text & "'"

                ElseIf (txtStatus.Text = "Confined.") Then

                    insertString = "INSERT INTO `patient_medicinem`(`ID`, `Name`, `room`, `Medicine`,
...
'" & txtTime.Text & "','" & txtDate.Text & "')"
    ...
    Private Sub refresher_Tick(sender As Object, e As EventArgs) Handles refresher.Tick
        ...
        SQL = "SELECT `Name`, `room`, `Medicine`, `Time`, `Date` FROM `patient_medicinem` WHERE Time='" & lblTime.Text & "'"
    ...
    Private Sub MainStation_Load(sender As Object, e As EventArgs) Handles MyBase.Load
